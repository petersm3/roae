...
- The complement distance analysis shows King Wen places complements significantly closer together than random (0th percentile), suggesting deliberate organization around opposition. This is a genuine finding. The constraint solver (`solve.py`) further shows that among all orderings satisfying the 7 discovered rules, King Wen **maximizes** complement distance — it keeps opposites as far apart as the constraint allows, balancing closeness against some other objective.
