...
Generated by `python3 roae.py --trials 10000`
...
Lag    Autocorrelation    Visualization
---    ---------------    -------------
0               1.0000   [               |             #]
1              -0.2469   [            #  |              ]
2              -0.0098   [               |              ]
...
Freq   Period  Magnitude  Spectrum
----   ------  ---------  --------
   1     63.0     0.0224  ##
   2     31.5     0.1823  #################
   3     21.0     0.0145  #
...
As we move through the King Wen sequence, we track the running count of yang
lines. A perfectly balanced sequence would hover around 3.0 yang lines per
hexagram. Drift above or below reveals sections dominated by yang (active,
creative energy) or yin (receptive, passive energy).
---
