...
- The constraint solver (`solve.py` + `solve.c`) finds that 5 rules narrow 10^89 possible orderings to **at least 742 million** (742,043,303 from partial enumeration — true count is higher; this figure is itself an undercount due to a hash-table bug fixed 2026-04-17). Only Position 1 is universally locked. Four additional boundary constraints uniquely determine King Wen among those millions. See [SOLVE.md](SOLVE.md) for the constraint analysis.
