...
- The constraint solver (`solve.py` + `solve.c`) finds that 5 rules narrow 10^89 possible orderings to **at least 20 million** (partial enumeration — true count is higher). Only Position 1 is universally locked. What makes King Wen unique among those millions is an open question. See [SOLVE.md](SOLVE.md) for the constraint analysis.
