...
The King Wen sequence is genuinely remarkable as a combinatorial object — 97% of its structure is mathematically determined, and only two specific choices among ~450 valid arrangements cannot be explained by any discovered rule. But McKenna's specific claims about what it *encodes* and what the wave *means* don't survive mathematical scrutiny.
