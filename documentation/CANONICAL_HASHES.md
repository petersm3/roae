...
| d3 100T | `915abf30cc58160fe123c755df2495e7999315afcfc6ef23f0ae22da6b56c3c5` | 3,432,399,297 | 3.43240 × 10⁹ | v1 (modern) | **Active** — generated 2026-05-09 by post-`f42f2ae` code (T9+c.1 + T9+d witnesses); provenance verified 2026-05-12. Archived `canonical-archive/t9c1/` |
...
| d3 11.2T (v2) | `2cc966e48399841ebb0c9ca67300f15bb578cc5481ed04fca5faffcb38ad6c4d` | 796,357,285 | 7.96357 × 10⁸ | **v2-bundled** (HEAD `9d00c48`) | **Active** — established 2026-05-17 on v2-bundled (C5 prune #68 + mid-walk C3 #67 + C3 optimistic-completion bound #70; #71 reverted). **+36,748,712 records (+4.83%) vs v1 11.2T** — the v2 prunes free dead-branch budget for live solutions at the same total budget. Deterministic across two independent runs same-day (attempt 1 transient bytes + Phase 2 recovery). Triple-storage archived: managed disk `solver-data-westus3:/20260516_v2bundled_11.2T_buildA_9d00c48/` + cold `canonical-archive/20260516_v2bundled_11.2T_buildA_9d00c48/` + claude `/tmp` fallback. solutions.bin.gz size 2,929,400,458 bytes (sha `4f1cd8b377dd4c7f6bc0e2358f7ce3a4c83f84ae04d798712b30c3fe57398cdd`). v1 sha `0c0fe37c…` remains the v1 anchor; both are valid for their respective solver lineages |
...
**Note on v1/v2 lineage:** v1 (`main` branch) produces the `0c0fe37c…` family at all canonical scales by design — its results are stable across the project lifetime, and the partition-invariance theorem chains the 11.2T canonical up to 100T. v2-bundled produces strictly more records at the same budget (because dead-branch pruning is more aggressive), but at scales ≥100T the v2/v1 record ratio approaches 1.00 because diminishing returns saturate (see HISTORY.md "#81 — v2 11.2T canonical preserved"). For the 100T and 560T canonical campaigns, the v2 lineage yields will be within ~1-2% of v1.
