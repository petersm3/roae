...
| d3 11.2T | `0c0fe37cf449cbc6e2754583964a60c185a7b387ee522fa43a8aac4fdb055db7` | 759,608,573 | 7.59609 × 10⁸ | v1 | **Active** — cross-build verified 2026-05-14: modern code (post-fix HEAD a2ead96) re-derivation on Spot D64als_v7 westus3 produced **byte-identical sha** to the historical 2026-04-30/05-01 generation. Confirms the 7-path validation that originally established this canonical. Archived to `canonical-archive/20260514_modern_v1_11.2T_buildA/` (Build B cross-build in flight at time of writing) |
