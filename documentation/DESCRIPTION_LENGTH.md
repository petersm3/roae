...
1/23.325 = 4.2874%, the published ~4.3% C2-rarity estimate landing exactly at this conditioning —
the C1-only fraction remains an estimate); C5|C1∩C2∩C4 = ×690.0868… (9.4306 bits). Corollary
