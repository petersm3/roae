...
records) has enumerated **≈1 part in 10²⁷** of the space; exhaustion, of the space or of any single branch, is off ⚠ **[the distinct-vs-distinct pairing is WITHDRAWN; stated raw-against-raw it is ≈1 part in 3.03×10²⁷ — see documentation/CORRECTIONS.md]** ⚠ **[BOUND, NOT EQUALITY — 2026-09-02, prose lane, propagating TR-4 v1.24: the numerator 43,876,464,466 counts per-sub-branch canonical keys, a lower bound on raw oriented leaves (CORRECTIONS.md 2026-08-28), so the raw-against-raw coverage is **at least** 1 part in 3.03×10²⁷ (43,876,464,466 ÷ 1.3287×10³⁸ = 3.30×10⁻²⁸; the estimate's own 95% CI moves the denominator only across 3.027–3.029×10²⁷), not ≈. The infeasibility conclusion is unaffected.]**
