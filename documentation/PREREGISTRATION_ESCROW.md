...
**`PREREG_CLASSA_QUERY_SET.md` — digest `4f6e0bdd41cd4b69de20dd311b35773dc29aaba6b57ddc27ea8f7ba5d1d8b322`, 51,794 bytes,
published 2026-09-06; digest updated 2026-09-11 after a SIXTH revision — two accepted EXTERNAL
findings (V3A-041#1 and V3A-041#2), applied together and before the freeze.**

*(Digest history: `6e21a148bfbb1ad57f7770f75cfdfd21f4f5c606258adec55231bc3066bfe2d9`, 41,881 bytes → `6b83cf4e0652dfe472e37c58f0cda4831a0300260cb8862e499b8a3ceb6f5dcb`, 45,882 bytes, when the QSET-3 pass's eight findings were applied → `fc0e40a6eac1c2ee9f159e599be02a8c69b42bc66fbf4f777cb801702230aca7`, 47,066 bytes, when QSET-4's four findings were applied. **QSET-4 attacked the QSET-3 repairs rather than the document**, and upheld all four: two of the eight repairs had been recorded as applied and were not, two left the corrected phrasing standing at a second site. Its adjudication then found three more the reviewer had missed, including an overclaim the QSET-3 repair itself introduced — that a 10-free-pair cell is a "sub-minute" brute force, disproved by executing it (475 s). This is the digest changing exactly as this entry said it would, which is why the entry exists: an escrow row that could not move would have had to be wrong here. → `2f592d2e084e75b098501bd5a0ece173f1dcdf5ead52144f74adc89eb2407b03`, 48,948 bytes. The first three supersessions were accepted EXTERNAL findings; the fourth is not — it is an internal clarification separating "needs the atlas file" from "is expensive" in the dependency table, which are different claims and were being read as one. The distinction is recorded because "caused by an external finding" was the original framing of this line and it would now be false for the latest entry. → `4f6e0bdd41cd4b69de20dd311b35773dc29aaba6b57ddc27ea8f7ba5d1d8b322`, 51,794 bytes, 2026-09-11, when the SIXTH revision applied two accepted findings of the Codex v3 review as adjudicated by Fable — and this one IS external again, on both counts. **V3A-041#1:** the file said the three questions were published before their answers were *computed*. They were not computed, but the g and t ladders that determine them had finished building, so what the file precedes is the **extraction** of those answers, not their existence; "unrun" now means read-out-or-recorded rather than merely recorded, and non-inspection is stated as attested rather than checkable. **V3A-041#2:** the escrowed head was claimed to begin at `k ≤ 20`, on the strength of a 475 s measurement of the k = 21 cell — but that measurement was an *enumerative* brute force, while the committed `verify.py` DP does the same cell in 0.19 s and reaches k = 16 in 162 s. The boundary was five cells too shallow and is now `k ≤ 15`, with the six cells k = 16..21 disclosed as computed during review and held privately, exactly as k = 21 already was. Both were settled by execution against this repository's own committed code, which is the kind of finding this escrow row exists to absorb.)*
