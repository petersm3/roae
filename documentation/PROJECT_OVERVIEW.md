...
- **The pair structure is perfect** — every one of the 32 pairs is a reverse or inverse, and zero random permutations out of 10,000 achieved this. (The pair structure itself is a classical observation — described by Yu Fan, 164–233 AD; Radisic 2026 proved it is the unique Hamming-cost-optimal pairing — see [CITATIONS.md](CITATIONS.md). The rarity measurement is ROAE's.)
