...
The sequence begins with the two most extreme hexagrams: all solid lines (䷀ #1, representing Heaven) followed by all broken lines (䷁ #2, representing Earth).
...
- **The starting orientation is forced.** ䷀ #1 must come before ䷁ #2 in all valid arrangements.
