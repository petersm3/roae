...
| `SOLVE_KNUTH_SCORE` | 0 | `=1`: `--estimate-knuth` additionally reports weighted canonical-mass fractions for three Cook-candidate rules (R-C1 final-pair anchor, R-C2 first-7 level coverage, R-C5 18:18 HEC split). Estimator-only; sha-neutral (2026-07-02). |
