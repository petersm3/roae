...
| `SOLVE_REGRESS_DIR` | `/mnt/work` if it exists, else `/tmp` | Directory for `--regression-test` / `--double-regression-test` artifacts (solve.c:40988, :40989-40918). ⚠ Row corrected 2026-09-01: previously `./` |
