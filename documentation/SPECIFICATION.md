...
*The sequence begins with the all-yang hexagram followed by the all-yin hexagram. The orientation is definitional — classically attested (the Xugua's Heaven-then-Earth opening) — and is NOT forced by the other constraints: complementation maps every C1∩C2∩C3∩C5-valid sequence opening (63, 0) to one opening (0, 63), so the constraint system itself admits both orientations (Complement Z₂ symmetry theorem below; the former "Theorem 6" forced-orientation claim is retracted, 2026-07-26).*
