...
documented, because there is no `BAD_C3` to fire. Closing it means a C3 leg in both
implementations, a `BAD_C3` counter kept counter-for-counter across the pair, and an eighth
negative control; this note stands until then. It is the **third instance** of the class the A3
