...
>
> **Second novel finding from 100T `--analyze` (2026-04-20, pending 560T re-validation):** the **boundary-minimum increases from 4 to 5** at deeper enumeration. At d2 10T and d3 10T, 4-boundary subsets uniquely identify KW. At d3 100T (the prior deepest canonical), **NO 4-subset works** — the deeper enumeration surfaces orderings that are 4-subset-indistinguishable from KW. Greedy-optimal 5-set: **{1, 4, 21, 25, 27}**. Boundaries {25, 27} remain mandatory across all three partitions (d2 10T, d3 10T, d3 100T) — the partition-stability claim holds. **The boundary-minimum at 560T may exceed 5 if more 5-subset-indistinguishable KW look-alikes appear in the deeper enumeration.** This is the highest-priority 560T analysis question: does the boundary-minimum grow to 6 (or higher) at 560 T? See SOLVE.md §Boundary analysis for the updated text and `solve_c/runs/20260419_100T_d3_d128westus3/analyze_output.log.gz` for the raw data.
>
