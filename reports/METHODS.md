...
| C1–C5 space size | ≈3.3×10³⁷ | 🔴 **WITHDRAWN 2026-08-24** — this *orientation-dedup* figure exceeds its own 31! ≈ 8.2228×10³³ ceiling by ~4,013×; see [CORRECTIONS.md](../documentation/CORRECTIONS.md). **The raw 1.3287×10³⁸ above is unaffected and stands.** | orientation-dedup | [TR-4] §Abstract |
