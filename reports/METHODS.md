...
| \|C1–C7\|, C3 dropped | 516,880,238,445,773,965,371,923,491,676,160 ≈ 5.16880×10³² | **exact** (single-instrument — IE pinned-step recount 2026-07-25, `verify.c --ie-pin-c6c7 --ie-no-quotient`; small-n-validated 52/52, 3-prime-CRT self-consistent, mod-24 N/A under pins; lands inside the prior 5.18×10³² estimate's 0.25% CI, ~0.22% below the point estimate — a 3rd independent estimator-calibration anchor) | raw | [TR-4] §4 |
