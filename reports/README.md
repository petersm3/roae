...
| [TR-11](TR11_EXACT_COUNTING_BY_SYMMETRY_QUOTIENT.md) | Exact Counting by Symmetry Quotient | The suite's exact full-scale counts: \|C1∩C2∩C4\| = 7.5706×10⁴¹ (the suite's **first** exact full-scale count, 2026-07-04) and \|C1∩C2∩C4∩C5\| = 1.097051×10³⁹ (the second, 2026-07-16; single-instrument — mod-24- and ladder-corroborated, not independently recomputed at full scale), each computed to the last digit; the estimator validated absolutely at 10³⁹ | symmetry-quotient DP + out-of-core mode + mod-24 gate |
