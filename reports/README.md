...
| [TR-5](TR5_SYMMETRY.md) | Symmetry | Order-48 group, complete over all 64! relabelings (v2.0; prose-proven with machine-checked finite parts — see §3 scope); free action (every solution has exactly 23 twins); a published negative corrected | proof + Lean + tree isomorphism |
