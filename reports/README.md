...
| [TR-11](TR11_EXACT_COUNTING_BY_SYMMETRY_QUOTIENT.md) | Exact Counting by Symmetry Quotient | The suite's exact full-scale counts: \|C1∩C2∩C4∩C5\| = 1.097051×10³⁹ computed to the last digit; the estimator validated absolutely at 10³⁹ | symmetry-quotient DP + out-of-core mode + mod-24 gate |
