...
*Technical report — **v1.17** (2026-08-09; `--f1-pairs` domain completed to all 19 realizable rung sizes and the two sites enumerating the accepted N updated to match — CLI surface only, no count or theorem changed; previously v1.16, 2026-08-06, Suenaga (2012) prior-art credit and counting-unit labels — see Revision history).*
