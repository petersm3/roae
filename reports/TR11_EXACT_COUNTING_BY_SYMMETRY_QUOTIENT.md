...
- Full exact count on commodity hardware: `./solve --f1-exact-c1c2c4c5 --f1-out-of-core DIR` — ~64 GB
  ...
  amplification near 1× (§8). Every layer file **recorded in DIR's manifest** is a checkpoint; after any
