...
*Technical report — **v1.12** (2026-07-26; §10(vi) label alignment — both companion counts two-instrument; previously v1.11, 2026-07-25; §10(vi)'s instrument half closed — independent full-scale recomputation by `verify.c --ie-count`, exact MATCH — see Revision history).*
