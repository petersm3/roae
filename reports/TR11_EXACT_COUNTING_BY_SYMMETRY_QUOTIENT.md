...
*Technical report — **v1.11** (2026-07-25; §10(vi)'s instrument half closed — independent full-scale recomputation by `verify.c --ie-count`, exact MATCH — see Revision history).*
...
10. **Honest limits — what stays estimated, and why.** (i) The flagship **1.3287×10³⁸ (|C1–C5|) remains
   ...
   **remains a statistical estimate**, now for stated economic rather than structural reasons. Two
   ...
   project-authored — no third-party recomputation exists. (The companion count \|C1∩C2∩C4\|
   remains single-instrument pending its own IE pass.)
