...
3. **The extended scoreboard: 31 further rules (2026-07-03 batch, 2×10¹⁰ probes).** The full candidate
   ...
   exception-co-location meta-rule `ccn8` (both Schulz rules' violations confined to S25/26) measures 2.6×10⁻⁷
...
6. **Attribution, lineage, and what is claimed.** Every rule is credited to its source, with lineage where
   ...
   Dingzuo); the 36-unit consolidation to **Lai Zhide (1525–1604)** (via [Schulz 1982](../documentation/CITATIONS.md#schulz1982); a candidate earlier statement of the 8+28=36 *count* — not the consolidation — by Shao Yong (11th c.) is recorded, second-hand and unconfirmed, in [CITATIONS.md](../documentation/CITATIONS.md#laizhide)); the 18:18 split to
