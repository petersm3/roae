...
leave-one-out subsets (5), three of the four two-rule cores (3: `core_parity_ccn4_unsat.drat.gz`,
`core_rhythm_ccn4_unsat.drat.gz`, `core_gender_ccn8_unsat.drat.gz`), and two encoding-validation gates
...
The fourth core's certificate is **not among those 21**. `core_gender_ccn4_unsat.drat`, cited in the
2026-08-28 correction above, was produced and drat-trim-verified off-tree; publishing it here (and
carrying the counts 14→15 and 21→22 through this report, certificates/README.md and verify_all.sh)
is outstanding work, and until it lands that citation names a file this directory does not contain.
