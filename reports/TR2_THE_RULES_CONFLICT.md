...
clears both published tables; the headline BF (≈5.2×10³–6.3×10³) sits far inside the strongest grade
of either. The band values are deliberately **not** re-fitted to either source here: re-labelling
...
- **These figures are NOT calibrated in the pooled sense** (added 2026-08-04; see
  ...
  frozen before it runs. The BF and posterior above are unchanged and not withdrawn; their
  *calibration support* is.
