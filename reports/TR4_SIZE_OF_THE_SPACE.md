...
5. **The boundary-information curve S(k) (2026-07-03).** S(k) = fraction of the full C1–C5 population
   ...
   ~15–20 boundaries** and superseding the earlier 13–14 figure; the heuristic floor
   k ≥ 12 is unaffected. A
...
2026-07-05 S(6)–S(8) measurement; wide error; heuristic floor k ≥ 12).
...
**k ≥ 12 boundaries** and an observed-rate projection of **≈ 13** — tightening this report's earlier
