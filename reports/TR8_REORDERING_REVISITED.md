...
10⁻⁴ clears it by only a factor of ~5 (not the ~500× that reading against 0.05 would suggest), and the dof-matched comparison above shows much of even that margin is
