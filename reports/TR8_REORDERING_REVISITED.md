...
⚠ **[SIDEDNESS CORRECTED 2026-09-24 (v1.17; Codex V3A-094#1, Q-742) — the anchor above is `dav_rotinv`'s
ONE-SIDED mass. The suite's convention since 2026-08-28 is two-sided, and two-sided `dav_rotinv` is
1.306×10⁻⁴, which is LARGER than 1.054426×10⁻⁴, so it no longer forces *i* ≥ 2
([CORRECTIONS](../documentation/CORRECTIONS.md), 2026-09-02 entry item 1, named this site and left it
uncorrected). Under both readings that respect the two-sided convention the BH margin is **~5.21×**, not
≥~10×: with the anchor doubled and the rarity left as is, rank 1 is not excluded and BH at rank 1 is the
Bonferroni bar (5.4945×10⁻⁴ ÷ 1.054426×10⁻⁴ = 5.21×); with the rarity doubled too (2.108853×10⁻⁴), *i* ≥ 2
returns but 2·(0.05/91) ÷ 2.108853×10⁻⁴ = 5.21× again, and the Bonferroni margin itself halves to 2.61×.
The ≥~10× survives only on a wholly one-sided ledger. The "~5× to ~10× or beyond" sentence below
inherits this. No verdict moves: the rarity clears the global bar under every reading.]**
...
1. **The 1979 position** — summarises their premise (no defensible global structure), their proposal
   ...
   reordering of his own — so the premise itself went unmeasured until now. ⚠ **[CORRECTED 2026-09-24
   (v1.17; Codex V3A-094#2, Q-742) — this sentence also said their construction's feasibility had
   stayed open until this report (registered as RP-0d63ea94). Their construction's feasibility was never
   undecided: their published 1979 ordering is itself a constructive existence proof of the hybrid they
   proposed, and this report's §"Second, by proof" says it "does not refute their construction". Only
   the *fully smooth* reading is decided here, and it is not what they proposed.]**
