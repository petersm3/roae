...
| v1.15 *(current)* | 2026-07-30 | **Observable-count precision (novelty-gate editorial pass).** §1's "~30-observable extraction battery" replaced with the exact figure: the **28-observable** extraction battery, identified as the base of the frozen **91-observable** global ledger (METHODS.md §Global observable ledger: 28 exploratory + 58 + 5 = 91). A tilde replaced by the frozen exact count; no value, ledger row, or verdict changed |
