...
| v1.16 *(current)* | 2026-08-01 | **Arithmetic-consistency fix (2026-08-01 in-house calibration review).** §5(a) quoted the comp∘rev-admitted low end as both "~+127" and "+125" two sentences apart; 146.3 − 19.0 = 127.3, so **+127** is correct and the "+125" is corrected. No ledger row, measurement, or conclusion changed |
