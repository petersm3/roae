...
**have no published full-scale invocation anywhere in the tracked corpus.** The only published
...
2026-09-02), and publishing the 5×10¹⁰ invocation with its thread count and archived stdout is the
open fix. Neither figure's *value* is in question here; its *reproducibility* is.
...
2. **The measured ledger.**
   ...
   | + C2 (no-5) | 7.5706×10⁴¹ (**exact**, orbit-quotient DP `solve --f1-exact-c1c2c4`, 2026-07-04; supersedes the 2026-07-03 estimator value 7.571×10⁴¹ ±0.01%, which it confirms) | 139.1 | 4.5 | ~3 (family of per-distance bans) | **≈ 0 (+0.5 to +2.0)**⁷ |
   ...
   **4.5438** bits (§2, exact marginals). The declared family is the per-distance bans, six members
   ...
   `:127–129` carry the same defect under a separate adjudication and are not edited here.
