...
CG = {
 "KW": SEQ,
 "MAWANGDUI_VALUES": [63,62,61,57,56,59,58,60,31,30,29,25,24,27,26,28,23,22,21,17,16,19,18,20,15,14,13,9,8,11,10,12,7,6,5,1,0,3,2,4,55,54,53,49,48,51,50,52,47,46,45,41,40,43,42,44,39,38,37,33,32,35,34,36],
...
expected = {
 ...
 "MAWANGDUI_VALUES": [16,22,4,0,16,16,15,24,0,1,14],
