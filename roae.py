...
def export_html(filename="report.html"):
    ...
    sections = [
        ("Hexagram reference table", print_table),
        ("Reverse vs. Inverse pair analysis", print_pairs),
        ("First order of difference (the 'wave')", lambda: print_wave(order=1, wrap=False)),
        ("Difference wave bar chart", print_barchart),
        ("Trigram analysis", print_trigrams),
        ("Nuclear hexagram analysis", print_nuclear),
        ("Line change positional analysis", print_line_changes),
        ("Complement distance analysis", print_complements),
        ("Palindrome analysis of the difference wave", print_palindromes),
        ("Upper Canon (1-30) vs. Lower Canon (31-64) comparison", print_canons),
        ("Autocorrelation of the difference wave", print_autocorrelation),
        ("Spectral analysis (Discrete Fourier Transform)", print_fft),
        ("Markov chain analysis", print_markov),
        ("Gray code comparison", print_graycode),
        ("Symmetry group analysis (XOR algebra)", print_symmetry),
        ("Alternative sequence comparison", print_sequences),
        ...
        ("Shannon entropy analysis", print_entropy),
        ("Path analysis (graph theory)", print_path),
        ("Constraint satisfaction analysis", print_constraints),
        ("Bootstrap confidence intervals", lambda: print_bootstrap(trials=10000)),
        ("Monte Carlo analysis", lambda: print_stats(trials=10000)),
    ]
