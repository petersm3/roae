...
documentation/RETRACTED_PHRASES.tsv	documentation/DEVELOPMENT.md	Constraint set	a1e7684b2f3b	LANDS: DEVELOPMENT.md line 2461-2463 is the Xugua sentence the note describes (review S3 re-pin by content, 2026-09-25; +2 for the Q-737 token rows, Opus AJ); the mined anchor is the METHODS.md section name the note also quotes
...
documentation/SOLVE_C_CLI.md	documentation/DEVELOPMENT.md	-	fdde236ba43a	ATTESTED: DEVELOPMENT.md line 1581 (1579 before the Q-737 token rows) is the 'Caveat — cross-host reproducibility' paragraph that bounds the tested toolchain class (content-checked 2026-09-25, Opus AF; cited from line 208)
